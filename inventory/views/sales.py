...
VALID_PAYMENT_METHODS = {value for value, _label in Sale.PAYMENT_METHODS}
ONE_STEP_PAYMENT_METHODS = VALID_PAYMENT_METHODS - {'mixed'}


def normalize_payment_method(payment_method):
    """Normalize legacy frontend values before validating sale payment flows."""
...
def sale_create(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            if payment_method not in ONE_STEP_PAYMENT_METHODS:
