...
SALE_CREATE_PAYMENT_METHODS = {'cash', 'wechat', 'alipay', 'card', 'balance', 'other'}
SALE_COMPLETE_PAYMENT_METHODS = SALE_CREATE_PAYMENT_METHODS | {'mixed'}


def normalize_payment_method(payment_method, allowed_methods):
    """Normalize legacy payment names and reject methods without backend accounting."""
